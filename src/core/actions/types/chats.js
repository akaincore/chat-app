export const FETCH_MY_CHATS_PENDING = Symbol('chats/FETCH_MY_CHATS_PENDING');
...
export const FETCH_ALL_CHATS_PENDING = Symbol('chats/FETCH_ALL_CHATS_PENDING');
...
export const FETCH_CHAT_PENDING = Symbol('chats/FETCH_CHAT_PENDING');
...
export const CREATE_CHAT_PENDING = Symbol('chats/CREATE_CHAT_PENDING');
...
export const DELETE_CHAT_PENDING = Symbol('chats/DELETE_CHAT_PENDING');
...
export const JOIN_CHAT_PENDING = Symbol('chats/JOIN_CHAT_PENDING');
...
export const LEAVE_CHAT_PENDING = Symbol('chats/LEAVE_CHAT_PENDING');
